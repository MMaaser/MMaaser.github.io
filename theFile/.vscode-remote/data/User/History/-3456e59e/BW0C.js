...
class Fight extends Phaser.Scene 
{
	...
	editorCreate() {
		...
		keypad = this.input.keyboard.createCursorKeys();
 		...
 		this.textbox("eeeeeeeeeeeeeeee","guapen");
	...
	update(){
		...
		var isEnterDown = keypad.enter.isDown;

		//clicks
		var click = pointer.leftButtonDown();
		var rightClick = pointer.rightButtonDown();

		if (click){
			this.textbox("we click", "guapen");
		}
	}
