...
function TEXTBOX(){
	...
	//var backRect = this.add.rectangle(300, 20, 400, 40, 0xFFFFFF);
	//const backRect = new Phaser.Geom.Rectangle(100,500,1080,200);
	//const colorWhite = this.add.graphics({ fillStyle: { color: 0xFFFFFF } });
	//colorWhite.fillRectShape(backRect);

	//const frontRect = new Phaser.Geom.Rectangle(105,505,1070,190);
	//const colorBlack = this.add.graphics({ fillStyle: { color: 0x1000000 } });
...
//var rect = this.add.rectangle(300, 20, 400, 4000, fillColor);
