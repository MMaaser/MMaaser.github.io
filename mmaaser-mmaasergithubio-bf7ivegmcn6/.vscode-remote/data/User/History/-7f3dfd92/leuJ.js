...
function attackChance(){
	var num = Math.floor(Math.random() * 11);
  	...
  	else if (num === 3 || num === 4){return 2;}
  	else if (num === 5 || num === 6){return 3;}
  	else if (num === 7 || num === 8){return 4;}
  	else if (num === 9 || num === 10){return 5;}
  	else {return 0;}
}

//big stinkly fumble 
function attack (item, target){
	var multiplier = attackChance();
